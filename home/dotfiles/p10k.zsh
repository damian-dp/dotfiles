# Generated by Powerlevel10k configuration wizard on 2024-06-20 at 21:20 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=false(
    # =========================[ Line #1 ]=========================
  ...
  typeset -g POWERLEVEL9K_DIR_TRUNCATE_TO_UNIQUE=true
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=200
  ...
  # Show the name of the virtual environment folder.
